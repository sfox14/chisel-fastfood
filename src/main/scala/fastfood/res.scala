...
Reservoir layer   - Parallel Processor
                  ...
                  - Binary or Ternary adder functions possible *NOT YET*
*/
...
// 
  ...
  //var nCycles = log2Up( negNums.length )
  //var pcycles = log2Up( posNums.length )
  //var minCycles = log2Up( negNums.length + posNums.length )
  //var maxCycles = math.max(nCycles, pCycles) + 1